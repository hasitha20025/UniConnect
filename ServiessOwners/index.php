        ...
        <div class=""> <!--top nav bar-->
            ...
            <nav class="navbar fixed-top " style=>
                <div class="container-fluid bg-body-tertiary shadow p-2 mb-1 bg-body-tertiary rounded">
                    ...
                    <a class="navbar-brand" href="./admin_index.html">
            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
                ...
                <div class="d-flex flex-column  px-3 " style="width: 400px;">
                    ...
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li>
                            <a href="./admin_index.html" class="nav-link  them-color ">
                        ...
                        <li>
                            <a href="./admin_services.html" class="nav-link link-body-emphasis">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li>
                            <a href="./admin_services_orders.html" class="nav-link link-body-emphasis">
                        ...
                        <li>
                            <a href="./admin_profile.html" class="nav-link link-body-emphasis ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="col-10">
                    <div class="container">
                       <a href="./admin_services_orders.html" class="nav-link">
            ...
            <div class="col-6">
                <h5 class="px-4 mt-3"> Services </h5>
                
                <div class="col-10">
                    <div class="container">
                        <a href="./admin_services.html" class="nav-link">
                        <div class="row border border-1 rounded shadow bg-body rounded">
                            <div class="col-auto p-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                                    class="bi bi-wallet-fill" viewBox="0 0 16 16">

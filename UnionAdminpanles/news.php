...
?>
    ...
    <div class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <div class="text-end">
            <a href="<?php echo Config::SITEURL; ?>UnionAdminpanles/additions/addNews.php">
      ...
      <script>
        ...
        function editRecord(newsId) {
            ...
            window.location.href = '<?php echo Config::SITEURL?>UnionAdminpanles/edit/editNews.php?id=' + newsId;
        }

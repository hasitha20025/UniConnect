...
<html lang="en">
  ...
  <body>
    ...
    <div class="col-sm-12">
            ...
            <input type="hidden" id="productSellerID" name="productSellerID" value="<?php echo $user_id; ?>">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["productSellerID"])) {
    ...
    if ($res == TRUE) {
      ...
      if(isset($_SESSION['user_id'])) {
          echo "<script>window.location.href = '" . Config::SITEURL . "productSellers/products.php?user_id=" . $_SESSION['user_id'] . "';</script>";
          exit(); 
      } else {

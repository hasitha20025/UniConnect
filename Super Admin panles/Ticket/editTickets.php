...
if (isset($_GET['id'])) {
    $ticketId = $_GET['id'];
    $sql = "SELECT * from tbl_ticket WHERE id = $ticketId";
    ...
    if ($res == TRUE) {
        ...
        if ($count > 0) {
            while ($rows = mysqli_fetch_assoc($res)) {
                ...
                $price = $rows["price"];
                $tiket_provider = $rows["tiket_provider"];
                $ticketId = $rows["id"];
            }
        }
    }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-4 shadow">
                ...
                <div class="modal-body p-5 pt-0">
                    ...
                    <form action="editTickets.php" method="post" enctype="multipart/form-data">
                          <div class="mb-3">
...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if ($image_name != "") {
            ...
            $image_name = "EDIT_Ticket" . rand(0000, 9999) . '.' . $ext;
    ...
    $updateQuery = "UPDATE tbl_ticket  SET title = '$new_title', price = '$TicketPrice', description = '$new_description', img = '$image_name',date = '$new_date', availability = '$availability',tiket_provider = '$tiket_provider' WHERE id = $ticketId";

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $insertQuery = "INSERT INTO tbl_news (image, title, date, description, view) VALUES (?, ?, ?, ?, ?)";
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content rounded-4 shadow">
                    <div class="modal-header p-5 pb-4 border-bottom-0">
                        <h2 class="fw-bold mb-4 fs-2">Add News Details</h2>
                    </div>
                    ...
                    <div class="modal-body p-5 pt-0">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <input type="file" class="form-control" name="news_img" id="thumbnail" required />
                            ...
                            <button class="w-100 mb-2 btn btn-lg rounded-3 btn-primary mt-3" type="submit">Add News</button>
                        </form>
                    </div>
                </div>
            </div>
